...
class Acceuil extends CI_Controller
{
    ...
    public function send_mail()
    {
        ...
        foreach ($_POST as $p => $data)
		{
            ...
            $message =
            "
            <h2 style='text-align: center; line-height: 1.5;'>".strtoupper("Bonjour Monsieur (Madame) ".$nom)." <br></h2>
            <p style='text-align: center; line-height: 1.5;'>Apres analyse de votre CV, l'entreprise Bralima vous invite à venir prendre part à l'interview</p>
            ";
            $title_email = "INVITATION | BRALIMA";
            $content_email = "
        ...
        ";
            senderEmail($title_email, $content_email, $email);
            
        }
        $session = array("email_sent"=>true);
