    ...
    <div class="card animated fadeInLeft">
        <div class="card-body">
            <header class="content__title">
                <p><b>Ajouter un CV</b></p>
                <!-- <small>Veuillez selectionner un poste et donner les criteres en les separant par une virgule</small> -->
            </header>
            <form class="row" action="<?=site_url('acceuil/cv')?>" method="post" enctype="multipart/form-data">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="form-group form-group--float">                        
                        <input type="file" class="form-control" id="cv" name="cv" placeholder="Fichier" required>
                        <i class="form-group__bar"></i>
                    </div>                   
